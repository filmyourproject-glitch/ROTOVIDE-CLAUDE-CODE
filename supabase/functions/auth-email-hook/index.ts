...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Verify your email — ROTOVIDE',
  invite: "You've been invited — ROTOVIDE",
  magiclink: 'Your sign-in link — ROTOVIDE',
  recovery: 'Reset your password — ROTOVIDE',
  email_change: 'Confirm your email change — ROTOVIDE',
  reauthentication: 'Your verification code — ROTOVIDE',
}
...
// Configuration
const SITE_NAME = "ROTOVIDE"
const SENDER_DOMAIN = "notify.rotovide.com"
const ROOT_DOMAIN = "rotovide.com"
const FROM_DOMAIN = "rotovide.com" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://rotovide.lovable.app"
