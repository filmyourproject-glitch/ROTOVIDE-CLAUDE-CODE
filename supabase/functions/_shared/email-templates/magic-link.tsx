...
export const MagicLinkEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your sign-in link — ROTOVIDE</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <div style={divider} />
        <Heading as="h2" style={h2}>Your Sign-In Link</Heading>
        <Text style={text}>
          Click the button below to sign in to ROTOVIDE. This link expires in
